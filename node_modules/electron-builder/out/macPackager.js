...
class MacPackager extends platformPackager_1.PlatformPackager {
    ...
    pack(outDir, arch, targets, postAsyncTasks) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!hasMas || targets.length > 1) {
                ...
                nonMasPromise = this.doPack(packOptions, outDir, appOutDir, this.platform.nodeName, arch, this.platformSpecificBuildOptions).then(() => this.sign(appOutDir, null)).then(() => {
            ...
            if (hasMas) {
                ...
                yield this.doPack(packOptions, outDir, appOutDir, "mas", arch, masBuildOptions);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (customSignOptions.entitlements != null) {
                ...
                if (resourceList.indexOf(p) !== -1) {
                    log_1.warn("entitlements.osx.plist is deprecated name, please use entitlements.mac.plist");
            ...
            if (customSignOptions.entitlementsInherit != null) {
                ...
                if (resourceList.indexOf(p) !== -1) {
                    log_1.warn("entitlements.osx.inherit.plist is deprecated name, please use entitlements.mac.inherit.plist");
    ...
    doFlat(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            return electron_osx_sign_1.flatAsync(opts);
        });
    }
