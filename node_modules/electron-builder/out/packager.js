        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (appPackageFile === devPackageFile) {
                if (this.options.appMetadata != null) {
                    this.devMetadata = deepAssign_1.deepAssign(this.devMetadata, this.options.appMetadata);
                }
                this.metadata = this.devMetadata;
            } else {
                this.metadata = deepAssign_1.deepAssign((yield readPackageJson_1.readPackageJson(appPackageFile)), this.options.appMetadata);
            }
    ...
    checkMetadata(appPackageFile, devAppPackageFile) {
        ...
        if (appMetadata !== this.devMetadata) {
            ...
            if (this.devMetadata.license != null) {
                log_1.warn(`license in the development package.json (${ devAppPackageFile }) is deprecated, please move to the application package.json`);
            }
        }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (this.isTwoPackageJsonProjectLayoutUsed) {
                if (this.devMetadata.build.npmRebuild === false) {
                    ...
                    yield util_1.installDependencies(this.appDir, this.electronVersion, metadata_1.Arch[arch], (yield util_1.statOrNull(path.join(this.appDir, "node_modules"))) == null ? "install" : "rebuild");
                } else {
