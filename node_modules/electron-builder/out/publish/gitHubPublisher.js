...
class GitHubPublisher {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            uploadAttempt: for (let i = 0; i < 3; i++) {
                try {
                    ...
                    }, this.token, gitHubRequest_1.uploadFile.bind(this, file, fileStat, fileName));
                } catch (e) {
    ...
    deleteRelease() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < 3; i++) {
                try {
                    return yield gitHubRequest_1.gitHubRequest(`/repos/${ this.owner }/${ this.repo }/releases/${ release.id }`, this.token, null, "DELETE");
                } catch (e) {
