...
function bintrayRequest(path, token) {
    let data = arguments.length <= 2 || arguments[2] === undefined ? null : arguments[2];
    let method = arguments.length <= 3 || arguments[3] === undefined ? "GET" : arguments[3];

    return request("api.bintray.com", path, token, data, method);
}
exports.bintrayRequest = bintrayRequest;
function request(hostname, path, token) {
    let data = arguments.length <= 3 || arguments[3] === undefined ? null : arguments[3];
    let method = arguments.length <= 4 || arguments[4] === undefined ? "GET" : arguments[4];
