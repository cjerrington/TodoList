...
class SquirrelWindowsTarget extends platformPackager_1.Target {
    ...
    build(arch, appOutDir) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const distOptions = yield this.computeEffectiveDistOptions(appOutDir, installerOutDir, setupFileName);
            ...
            const packagePrefix = `${ appInfo.name }-${ electron_winstaller_fixed_1.convertVersion(version) }-`;
    ...
    computeEffectiveDistOptions(appOutDir, installerOutDir, setupExeName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const options = Object.assign({
                ...
                iconUrl: iconUrl,
                setupIcon: yield packager.getIconPath(),
