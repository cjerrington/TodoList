...
declare module 'electron-builder/out/asarUtil' {
  ...
  export function createAsarArchive(src: string, resourcesPath: string, options: AsarOptions, filter: (file: string) => boolean): Promise<any>
...
declare module 'electron-builder/out/builder' {
  ...
  export function createPublisher(packager: Packager, options: PublishOptions, isPublishOptionGuessed?: boolean): Promise<Publisher | null>
...
declare module 'electron-builder/out/packager' {
  ...
  import { PackagerOptions, BuildInfo, ArtifactCreated, Target } from "electron-builder/out/platformPackager"
  import { AppInfo } from "electron-builder/out/appInfo"
...
declare module 'electron-builder/out/packager/linux' {
  import { ElectronPackagerOptions } from "electron-builder/out/packager/dirPackager"
  import { Promise as BluebirdPromise } from "bluebird"

  export function createApp(opts: ElectronPackagerOptions, appOutDir: string, initializeApp: () => Promise<any>): BluebirdPromise<any[]>
}
...
declare module 'electron-builder/out/packager/win32' {
  import { Promise as BluebirdPromise } from "bluebird"
  import { ElectronPackagerOptions } from "electron-builder/out/packager/dirPackager"
...
declare module 'electron-builder/out/platformPackager' {
  ...
  export function deprecatedUserIgnoreFilter(opts: ElectronPackagerOptions, appDir: string): (file: string) => any
}
...
declare module 'electron-builder/out/publish/BintrayPublisher' {
  ...
  export class BintrayPublisher implements Publisher {
    constructor(user: string, apiKey: string, version: string, packageName: string, repo?: string, options?: PublishOptions)
...
declare module 'electron-builder/out/publish/gitHubRequest' {
  /// <reference types="node" />
  ...
  export function bintrayRequest<T>(path: string, token: string | null, data?: {
    [name: string]: any
  } | null, method?: string): BluebirdPromise<T>
...
declare module 'electron-builder/out/targets/LinuxTargetHelper' {
  ...
  export class LinuxTargetHelper {
    ...
    constructor(packager: PlatformPackager<LinuxBuildOptions>, cleanupTasks: Array<() => Promise<any>>)
...
declare module 'electron-builder/out/targets/nsis' {
  ...
  export default class NsisTarget extends Target {
    ...
    finishBuild(): Promise<any>
    protected getResource(custom: string | n, name: string): Promise<string | null>
  }
}
...
declare module 'electron-builder/out/targets/squirrelWindows' {
  ...
  export default class SquirrelWindowsTarget extends Target {
    ...
    build(arch: Arch, appOutDir: string): Promise<void>
    computeEffectiveDistOptions(appOutDir: string, installerOutDir: string, setupExeName: string): Promise<WinBuildOptions>
  }
}
...
declare module 'electron-builder/out/util/filter' {
  ...
  export function listDependencies(appDir: string, production: boolean): Promise<Array<string>>
}
