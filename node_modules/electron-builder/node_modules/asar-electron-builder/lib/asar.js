(function() {
  var Filesystem, disk, fs, isUnpackDir, minimatch, mkdirp, os, path;
  ...
  module.exports.extractAll = function(archive, dest) {
    var content, destFilename, error, error1, file, filename, filenames, filesystem, followLinks, i, len, linkDestPath, linkSrcPath, linkTo, relativePath, results;
    filesystem = disk.readFilesystemSync(archive);
