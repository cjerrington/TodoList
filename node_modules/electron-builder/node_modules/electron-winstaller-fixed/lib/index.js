...
let copyUpdateExe = (() => {
  var ref = (0, _bluebird.coroutine)(function* (desitination, options, rcEditOptions) {
    yield (0, _fsExtraP.copy)(vendor('Update.exe'), desitination);
    if (options.setupIcon && options.skipUpdateIcon !== true) {
      yield rcedit(desitination, rcEditOptions);
    }

    if (options.sign != null) {
      yield options.sign(desitination);
    }
  });
  return function copyUpdateExe(_x, _x2, _x3) {
...
let createWindowsInstaller = exports.createWindowsInstaller = (() => {
  ...
  return function createWindowsInstaller(_x4) {
    return ref.apply(this, arguments);
  };
})();
...
let build = (() => {
  var ref = (0, _bluebird.coroutine)(function* (options, stageDir) {
    ...
    const promises = [copyUpdateExe(appUpdate, options, rcEditOptions), (0, _fsExtraP.emptyDir)(outputDirectory)];
    ...
    yield rcedit(setupPath, rcEditOptions);
...
<coreProperties xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  ...
  return function pack(_x7, _x8, _x9, _x10, _x11, _x12) {
    return ref.apply(this, arguments);
  };
})();
...
let releasify = (() => {
  ...
  return function releasify(_x13, _x14, _x15) {
    return ref.apply(this, arguments);
  };
})();
...
let msi = (() => {
  ...
  return function msi(_x16, _x17, _x18, _x19) {
    return ref.apply(this, arguments);
  };
})();
